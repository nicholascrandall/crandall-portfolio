        ...
        return (
            <div>
                ...
                <span>
                    <article>
                        <h2>Checkers</h2>
                        <a href="https://github.com/nicholascrandall/checkers"><img src={Checkers} alt="checkers" className="projectPic" /></a>
                        <p>Built with HTML5, CSS3, and JavaScript. A GitHub Pages hosted two player (local) game of Checkers.</p>
                    </article>
                    <article>
                        <h2>Trailblazers</h2>
                        <a href="https://github.com/nicholascrandall/Trailblazer"><img src={Trailblazers} alt="Trailblazers" className="projectPic" /></a>
                    ...
                    <article>
                        <h2>Insight</h2>
                        <a href="https://github.com/nicholascrandall/Insight"><img src={Insight} alt="Insight" className="projectPic" /></a>
